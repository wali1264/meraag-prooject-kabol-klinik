        ...
        <div className="bg-white p-8 rounded-[32px] border border-slate-100 shadow-sm space-y-4">
          ...
          <div className="space-y-1">
            <h3 className="text-3xl font-black text-blue-600">
               {companies.reduce((sum, c) => sum + c.ledger.filter(l => l.description.includes('رزرو') || l.description.includes('ترانسپورت') || l.description.includes('غذا')).length, 0)} مورد
            </h3>
            <p className="text-xs text-slate-400 font-bold">هوتل، ترانسپورت و غذا</p>
          </div>
        </div>
      </div>
